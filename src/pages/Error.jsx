                    ...
                    <div className="container mx-auto px-4">
                        <div className="w-full">
                            <div className="w-full text-center mt-10">
                                <h1 className="font-jakarta text-2xl text-white font-medium leading-sung md:text-3xl md:leading-snug tracking-wide">Error</h1>
                            </div>
                            <div className="w-full absolute bottom-[20px] left-1/2 transform -translate-x-1/2 text-center">
                                <div className="w-auto flex items-center justify-center gap-1">
                                    ...
                                    <Link to='/' className="font-jakarta text-[15px] font-semibold text-white">Error</Link>
                                </div>
                            </div>
                        </div>
                    </div>
                </div>
                <div className="w-full py-16 lg:py-26">
                    <div className="container mx-auto px-4">
                        <div className="w-full flex items-center justify-center">
                            <img src='/error/careercode-404.gif' alt="error image" />
                        </div>
                        <div className="w-full text-center">
                            <Link to='/' className="font-jakarta font-semibold text-emerald-600 underline">Go To Home</Link>
                        </div>
                    </div>
                </div>
            </section>
